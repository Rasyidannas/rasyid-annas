...
const data = {
  about_me:
    "I am based in Indonesia and have 6+ years of experience in design and freelance. I have worked as a freelancer at Fiverr and Upwork. I had 100+ clients and reviews 4.9 reviews. 1-year remote work for Storya and 3 months for Habilis Solution. In 2024 I started focusing on studying frontend and backend more deeply such as React js and Laravel.",
  skill:
